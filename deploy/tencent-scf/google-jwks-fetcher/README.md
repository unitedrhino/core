...
- 国内生产服务不直接访问 Google。
- 函数 URL 保持公网访问，但必须携带 `X-YKHL-JWKS-TOKEN` 共享密钥。
...
- `YKHL_JWKS_ACCESS_TOKEN`：函数 URL 访问密钥，不提交仓库。

后端配置：

- `GOOGLE_JWKS_URL=https://1314818510-kpeq782dzv.ap-singapore.tencentscf.com`
