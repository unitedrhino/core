...
联犀是一个基于golang开发的轻量级云原生微服务物联网平台.
...
* 易部署 -- 一键安装所有依赖,一键运行联犀
* 易集成 -- 可以通过http,grpc,甚至直接将联犀作为包集成进自己系统

git地址:

* 后端github地址:[https://github.com/i-Things/core](https://github.com/i-Things/core)
* 后端gitee地址:[https://gitee.com/unitedrhino/core](https://gitee.com/unitedrhino/core)

## 产品架构

联犀物联网平台提供跨不同设备和数据源的通用接入及管理平台,在整个物联网架构中起到承上启下的中介作用，
...
| 平台价值     | 描述                                                                             |
| ------------ |--------------------------------------------------------------------------------|
| 拓展能力强   | 公司发展有不同的阶段,应用场景也有不同的需要,联犀同时支持单体和微服务便于开发者不需要维护两套代码同时单体不足以满足公司需要时也可以很便捷的切换为微服务架构 |
...
- 时刻招募相信分布式办公的你
- 参与方式: 先搭建环境并运行起联犀, 社区分配一两个简单功能开始入手
- 微信二维码
