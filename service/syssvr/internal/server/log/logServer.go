...
import (
	...
	"gitee.com/unitedrhino/core/service/syssvr/internal/logic/log"
...
func (s *LogServer) LoginLogCreate(ctx context.Context, in *sys.LoginLogCreateReq) (*sys.Empty, error) {
	l := loglogic.NewLoginLogCreateLogic(ctx, s.svcCtx)
	return l.LoginLogCreate(in)
}

func (s *LogServer) OperLogCreate(ctx context.Context, in *sys.OperLogCreateReq) (*sys.Empty, error) {
