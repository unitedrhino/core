...
type SysTenantInfo struct {
	...
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_sys_tenant_info_code;uniqueIndex:idx_sys_tenant_info_name"`
}
...
type SysTenantApp struct {
	ID             int64               `gorm:"column:id;type:BIGINT;primary_key;AUTO_INCREMENT"`                                  // id编号
	TenantCode     dataType.TenantCode `gorm:"column:tenant_code;uniqueIndex:idx_sys_tenant_app_tc_ac;type:VARCHAR(50);NOT NULL"` // 租户编码
	AppCode        string              `gorm:"column:app_code;uniqueIndex:idx_sys_tenant_app_tc_ac;type:VARCHAR(50);NOT NULL"`    // 应用编码 这里只关联主应用,主应用授权,子应用也授权了
...
type SysTenantAppModule struct {
	TenantCode dataType.TenantCode `gorm:"column:tenant_code;uniqueIndex:idx_sys_tenant_app_module_tc_ac;type:VARCHAR(50);NOT NULL"` // 租户编码
	ID         int64               `gorm:"column:id;type:BIGINT;primary_key;AUTO_INCREMENT"`                                         // id编号
	AppCode    string              `gorm:"column:app_code;uniqueIndex:idx_sys_tenant_app_module_tc_ac;type:VARCHAR(50);NOT NULL"`    // 应用编码 这里只关联主应用,主应用授权,子应用也授权了
	ModuleCode string              `gorm:"column:module_code;uniqueIndex:idx_sys_tenant_app_module_tc_ac;type:VARCHAR(50);NOT NULL"` // 模块编码
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_sys_tenant_app_module_tc_ac"`
...
type SysTenantAppMenu struct {
	TempLateID int64               `gorm:"column:template_id;uniqueIndex:idx_sys_tenant_app_menu_template_id;type:BIGINT;NOT NULL"`      // 模板id
	TenantCode dataType.TenantCode `gorm:"column:tenant_code;uniqueIndex:idx_sys_tenant_app_menu_template_id;type:VARCHAR(50);NOT NULL"` // 租户编码
	AppCode    string              `gorm:"column:app_code;uniqueIndex:idx_sys_tenant_app_menu_template_id;type:VARCHAR(50);NOT NULL"`    // 应用编码 这里只关联主应用,主应用授权,子应用也授权了
	...
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;uniqueIndex:idx_sys_tenant_app_menu_template_id;default:0;index"`
}
...
type SysTenantAgreement struct {
	ID         int64               `gorm:"column:id;type:BIGINT;primary_key;AUTO_INCREMENT"`                                        // id编号
	TenantCode dataType.TenantCode `gorm:"column:tenant_code;uniqueIndex:idx_sys_tenant_agreement_tc_ac;type:VARCHAR(50);NOT NULL"` // 租户编码
	Code       string              `gorm:"column:code;uniqueIndex:idx_sys_tenant_agreement_tc_ac;type:VARCHAR(50);NOT NULL"`        // 协议编码
	Name       string              `gorm:"column:name;type:VARCHAR(50);NOT NULL"`                                                   //协议名称
	Title      string              `gorm:"column:title;type:VARCHAR(50);"`
	Content    string              `gorm:"column:content;type:text;"`
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_sys_tenant_agreement_tc_ac"`
}
