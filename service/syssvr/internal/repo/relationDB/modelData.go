...
type SysDataArea struct {
	...
	ProjectID      dataType.ProjectID  `gorm:"column:project_id;uniqueIndex:ri_mi;type:bigint;NOT NULL"`         // 所属项目ID(雪花ID)
...
type SysUserAreaApply struct {
	...
	ProjectID  dataType.ProjectID  `gorm:"column:project_id;uniqueIndex:ri_mi;type:bigint;NOT NULL"`       // 所属项目ID(雪花ID)
	AreaID     dataType.AreaID     `gorm:"column:area_id;uniqueIndex:ri_mi;type:bigint;NOT NULL"`          // 区域ID(雪花ID)
...
type SysDataProject struct {
	ID         int64               `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	TenantCode dataType.TenantCode `gorm:"column:tenant_code;uniqueIndex:ri_mi;type:VARCHAR(50);default:default"` // 租户编码
