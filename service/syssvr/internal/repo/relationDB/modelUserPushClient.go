...
type SysUserPushClient struct {
	...
	TenantCode   dataType.TenantCode `gorm:"column:tenant_code;type:VARCHAR(50);NOT NULL;uniqueIndex:idx_sys_user_push_client_tc_un;index:idx_sys_user_push_client_tc_cid,priority:1"`
	UserID       int64               `gorm:"column:user_id;type:BIGINT;NOT NULL;uniqueIndex:idx_sys_user_push_client_tc_un"`
	PushClientID string              `gorm:"column:push_client_id;type:VARCHAR(64);NOT NULL;uniqueIndex:idx_sys_user_push_client_tc_un;index:idx_sys_user_push_client_tc_cid,priority:2"`
	...
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_sys_user_push_client_tc_un;index:idx_sys_user_push_client_tc_cid,priority:3"`
}
