...
type ApiInfo struct {
	...
	AuthType     int64  `protobuf:"varint,8,opt,name=authType,proto3" json:"authType,omitempty"`         // // 1(all) 全部人可以操作 2(admin) 只有管理员可以操作 3(superAdmin) 只有超管可以操作(超管是跨租户的)
...
var file_proto_sys_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x0a, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xcf,
