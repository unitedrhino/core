// TemplateCode generated by protoc-gen-go-grpc. DO NOT EDIT.
// versions:
...
const (
	MessageManage_Ping_FullMethodName = "/sys.MessageManage/ping"
)
...
func (c *messageManageClient) Ping(ctx context.Context, in *Response, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, MessageManage_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MessageManageServer interface {
	Ping(context.Context, *Response) (*Response, error)
...
func (UnimplementedMessageManageServer) Ping(context.Context, *Response) (*Response, error) {
...
func _MessageManage_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Response)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageManageServer).Ping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageManage_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageManageServer).Ping(ctx, req.(*Response))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MessageManage_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ping",
			Handler:    _MessageManage_Ping_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/sys.proto",
