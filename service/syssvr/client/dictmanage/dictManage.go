...
func (m *defaultDictManage) DictInfoUpdate(ctx context.Context, in *DictInfo, opts ...grpc.CallOption) (*Response, error) {
	client := sys.NewDictManageClient(m.cli.Conn())
	return client.DictInfoUpdate(ctx, in, opts...)
}

func (d *directDictManage) DictInfoUpdate(ctx context.Context, in *DictInfo, opts ...grpc.CallOption) (*Response, error) {
	return d.svr.DictInfoUpdate(ctx, in)
}

func (m *defaultDictManage) DictInfoDelete(ctx context.Context, in *WithID, opts ...grpc.CallOption) (*Response, error) {
	client := sys.NewDictManageClient(m.cli.Conn())
	return client.DictInfoDelete(ctx, in, opts...)
}

func (d *directDictManage) DictInfoDelete(ctx context.Context, in *WithID, opts ...grpc.CallOption) (*Response, error) {
...
func (m *defaultDictManage) DictDetailUpdate(ctx context.Context, in *DictDetail, opts ...grpc.CallOption) (*Response, error) {
	client := sys.NewDictManageClient(m.cli.Conn())
	return client.DictDetailUpdate(ctx, in, opts...)
}

func (d *directDictManage) DictDetailUpdate(ctx context.Context, in *DictDetail, opts ...grpc.CallOption) (*Response, error) {
	return d.svr.DictDetailUpdate(ctx, in)
}

func (m *defaultDictManage) DictDetailDelete(ctx context.Context, in *WithID, opts ...grpc.CallOption) (*Response, error) {
	client := sys.NewDictManageClient(m.cli.Conn())
	return client.DictDetailDelete(ctx, in, opts...)
}

func (d *directDictManage) DictDetailDelete(ctx context.Context, in *WithID, opts ...grpc.CallOption) (*Response, error) {
