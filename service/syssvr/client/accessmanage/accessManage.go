...
func (m *defaultAccessManage) ApiInfoUpdate(ctx context.Context, in *ApiInfo, opts ...grpc.CallOption) (*Empty, error) {
	client := sys.NewAccessManageClient(m.cli.Conn())
	return client.ApiInfoUpdate(ctx, in, opts...)
}

func (d *directAccessManage) ApiInfoUpdate(ctx context.Context, in *ApiInfo, opts ...grpc.CallOption) (*Empty, error) {
	return d.svr.ApiInfoUpdate(ctx, in)
}

func (m *defaultAccessManage) ApiInfoDelete(ctx context.Context, in *WithID, opts ...grpc.CallOption) (*Empty, error) {
	client := sys.NewAccessManageClient(m.cli.Conn())
...
func (m *defaultAccessManage) AccessInfoUpdate(ctx context.Context, in *AccessInfo, opts ...grpc.CallOption) (*Empty, error) {
	client := sys.NewAccessManageClient(m.cli.Conn())
	return client.AccessInfoUpdate(ctx, in, opts...)
}

func (d *directAccessManage) AccessInfoUpdate(ctx context.Context, in *AccessInfo, opts ...grpc.CallOption) (*Empty, error) {
	return d.svr.AccessInfoUpdate(ctx, in)
}

func (m *defaultAccessManage) AccessInfoDelete(ctx context.Context, in *WithID, opts ...grpc.CallOption) (*Empty, error) {
	client := sys.NewAccessManageClient(m.cli.Conn())
	return client.AccessInfoDelete(ctx, in, opts...)
}

func (d *directAccessManage) AccessInfoDelete(ctx context.Context, in *WithID, opts ...grpc.CallOption) (*Empty, error) {
