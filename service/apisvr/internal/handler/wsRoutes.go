...
import (
	...
	systemnotifychannel "gitee.com/i-Things/core/service/apisvr/internal/handler/system/notify/channel"
	systemnotifyconfig "gitee.com/i-Things/core/service/apisvr/internal/handler/system/notify/config"
	systemnotifyconfigtemplate "gitee.com/i-Things/core/service/apisvr/internal/handler/system/notify/config/template"
	...
	systemtenantappcore "gitee.com/i-Things/core/service/apisvr/internal/handler/system/tenant/app/core"
...
func RegisterWsHandlers(server *ws.Server, serverCtx *svc.ServiceContext) {
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/app/policy"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/area/profile"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/notify/channel"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/notify/config"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/notify/config/template"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/notify/message/info"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/notify/template"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/project/profile"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/slot/info"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/tenant/app/core"),
	)
	...
	server.AddRoutes(
		...
		ws.WithPrefix("/api/v1/system/tenant/config"),
	)
